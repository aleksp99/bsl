...
public:
  enum {
    ...
    PREPROC_LINUX = 105, PREPROC_WINDOWS = 106, PREPROC_MACOS = 107, PREPROC_IDENTIFIER = 108, 
    PREPROC_LINE_COMMENT = 109, PREPROC_NEWLINE = 110, PREPROC_ANY = 111, 
    ...
    PREPROC_DELETE_ANY = 124, WAIT_KEYWORD = 125
  };
  ...
  enum {
    ...
    RuleTernaryOperator = 66, RuleFileCodeBlockBeforeSub = 67, RuleFileCodeBlock = 68, 
    RuleCodeBlock = 69, RuleNumeric = 70, RuleParamList = 71, RuleParam = 72, 
    RuleDefaultValue = 73, RuleConstValue = 74, RuleMultilineString = 75, 
    RuleString = 76, RuleStatement = 77, RuleAssignment = 78, RuleCallParamList = 79, 
    RuleCallParam = 80, RuleExpression = 81, RuleOperation = 82, RuleCompareOperation = 83, 
    RuleBoolOperation = 84, RuleUnaryModifier = 85, RuleMember = 86, RuleNewExpression = 87, 
    RuleTypeName = 88, RuleMethodCall = 89, RuleGlobalMethodCall = 90, RuleMethodName = 91, 
    RuleComplexIdentifier = 92, RuleModifier = 93, RuleAcceptor = 94, RuleLValue = 95, 
    RuleAccessCall = 96, RuleAccessIndex = 97, RuleAccessProperty = 98, 
    RuleDoCall = 99, RuleCompoundStatement = 100
  };

  BSLParser(antlr4::TokenStream *input);
  ~BSLParser();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *WAIT_KEYWORD();
