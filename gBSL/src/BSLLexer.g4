...
fragment RU_A: '\u0410' | '\u0430'; // 'А' | 'а';
fragment RU_B: '\u0411' | '\u0431'; // 'Б' | 'б';
fragment RU_V: '\u0412' | '\u0432'; // 'В' | 'в';
fragment RU_G: '\u0413' | '\u0433'; // 'Г' | 'г';
fragment RU_D: '\u0414' | '\u0434'; // 'Д' | 'д';
fragment RU_YO: '\u0401' | '\u0451'; // 'Ё' | 'ё';
fragment RU_E: '\u0415' | '\u0435'; // 'Е' | 'е';
fragment RU_ZH: '\u0416' | '\u0436'; // 'Ж' | 'ж';
fragment RU_Z: '\u0417' | '\u0437'; // 'З' | 'з';
fragment RU_I: '\u0418' | '\u0438'; // 'И' | 'и';
fragment RU_J: '\u0419' | '\u0439'; // 'Й' | 'й';
fragment RU_K: '\u041A' | '\u043A'; // 'К' | 'к';
fragment RU_L: '\u041B' | '\u043B'; // 'Л' | 'л';
fragment RU_M: '\u041C' | '\u043C'; // 'М' | 'м';
fragment RU_N: '\u041D' | '\u043D'; // 'Н' | 'н';
fragment RU_O: '\u041E' | '\u043E'; // 'О' | 'о';
fragment RU_P: '\u041F' | '\u043F'; // 'П' | 'п';
fragment RU_R: '\u0420' | '\u0440'; //  'Р' | 'р';
fragment RU_S: '\u0421' | '\u0441'; //  'С' | 'с';
fragment RU_T: '\u0422' | '\u0442'; //  'Т' | 'т';
fragment RU_U: '\u0423' | '\u0443'; //  'У' | 'у';
fragment RU_F: '\u0424' | '\u0444'; //  'Ф' | 'ф';
fragment RU_H: '\u0425' | '\u0445'; //  'Х' | 'х';
fragment RU_C: '\u0426' | '\u0446'; //  'Ц' | 'ц';
fragment RU_CH: '\u0427' | '\u0447'; //  'Ч' | 'ч';
fragment RU_SH: '\u0428' | '\u0448'; //  'Ш' | 'ш';
fragment RU_SCH: '\u0429' | '\u0449'; //  'Щ' | 'щ';
fragment RU_SOLID_SIGN: '\u042A' | '\u044A'; //  'Ъ' | 'ъ';
fragment RU_Y: '\u042B' | '\u044B'; //  'Ы' | 'ы';
fragment RU_SOFT_SIGN: '\u042C' | '\u044C'; //  'Ь' | 'ь';
fragment RU_EH: '\u042D' | '\u044D'; //  'Э' | 'э';
fragment RU_YU: '\u042E' | '\u044E'; //  'Ю' | 'ю';
fragment RU_YA: '\u042F' | '\u044F'; //  'Я' | 'я';
fragment A: 'A' | 'a';
fragment B: 'B' | 'b';
fragment C: 'C' | 'c';
fragment D: 'D' | 'd';
